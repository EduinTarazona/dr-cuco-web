      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <h2
            ...
            style={{ fontSize: 'clamp(1.6rem, 3.5vw, 2.4rem)', fontFamily: 'Bricolage Grotesque, sans-serif' }}
          >
            ¿Lista para tu consulta?
          </h2>
          <p className="text-white/80 mb-8 max-w-lg mx-auto" style={{ fontSize: '1.05rem' }}>
            El Dr. Cuco te atiende en Bogotá y Villavicencio. Agenda por WhatsApp en minutos, sin filas ni formularios.
          </p>
          <a
          ...
          <p className="mt-5 text-white/60 text-sm">
            Bogotá · Villavicencio · Atención confidencial
          </p>
        </div>
      </div>
    </section>
